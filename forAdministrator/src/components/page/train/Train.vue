            ...
            <div class="form-box" >
                <el-tabs type="border-card" @tab-click="handleTabClick">
                    <el-tab-pane label="添加列车">
                        <el-form ref="trainToAdd" :model="trainToAdd" label-width="80px">
                            <el-form-item label="列车ID">
                                <el-input v-model="trainToAdd.ID" placeholder="请输入列车ID"></el-input>
                            </el-form-item>
                            <el-form-item label="列车型号">
                                <el-radio-group v-model="trainToAdd.trainType">
                            ...
                            <el-form-item label="客/货运">
                                <el-radio-group v-model="trainToAdd.trainFreightType">
                    ...
                    <el-tab-pane label="删除列车">
                        <el-form ref="trainToDelete" :model="trainToDelete" label-width="80px" @click="handleTabClick">
                            <el-form-item label="列车ID">
                                <el-input v-model="trainToDelete.ID" placeholder="请输入列车ID"></el-input>
                            </el-form-item>
                            <el-form-item>
                    ...
                    <el-tab-pane label="查找列车">
                        <div v-show="searchButton">
                            <el-form ref="trainToSearch" :model="trainToSearch" label-width="80px" @click="handleTabClick">
                                <el-form-item label="列车ID">
                                    <el-input v-model="trainToSearch.ID" placeholder="请输入列车ID"></el-input>
                                </el-form-item>
                                <el-form-item>
                ...
                axios.get('../Carriages.json',{
                    ...
                    .then(function (response) {
                        ...
                        for (var i in data) {
                            ...
                            if(data[i].carriageRunningSituation == 0){
                                _carriageRunningSituation = "维修中";
                            }else{
                                _carriageRunningSituation = "运营中";
                            }

                            newData={ID: data[i].ID, carriageFreightType: _carriageFreightType,
                            capacity: _capacity, carriageRunningSituation: _carriageRunningSituation,
                            belongingTrain: data[i].belongingTrain, carriageCarryingSituation: data[i].carriageCarryingSituation};
